...
type ChannelOtherSettings struct {
	...
	ClientRestrictionClients []string              `json:"client_restriction_clients,omitempty"` // 客户端标识列表，如 "claude-code"、"codex"/"codex-cli"（含 Desktop/VS Code/TUI）、"gemini-cli" 或自定义 UA 关键词
